...
with graph.as_default():
    ...
    f1=tf.get_variable("f1", shape=[1,3,2], initializer=tf.contrib.layers.xavier_initializer())

    hid=tf.nn.conv1d(tfseq,filters=f1,stride=1,padding="SAME")

    logits=tf.squeeze(tf.layers.max_pooling1d(hid,12,1))
